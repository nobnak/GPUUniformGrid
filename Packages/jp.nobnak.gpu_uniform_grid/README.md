...
Or add the OpenUPM scoped registry (`https://package.openupm.com`, scope `jp.nobnak`) and install from Package Manager. Pin the version in `manifest.json` (e.g. `"jp.nobnak.gpu_uniform_grid": "1.8.1"`) to match the release you use.
