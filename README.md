...
**Encoding:** **3D** cells use a **Morton `uint`** per cell (`UniformGridParams`, **`bitsPerAxis` ≤ 10**). **2D** uses a separate encoding with **`UniformGridParams2D`** (**≤ 16 bits per axis**). Pick **`GPUUniformGrid`** / **`GPUUniformGrid2D`** and matching HLSL under [`ShaderLibrary/LinkedList/`](Packages/jp.nobnak.gpu_uniform_grid/ShaderLibrary/LinkedList/) (`UniformGrid*.hlsl`, [`UniformGridLinkedList.hlsl`](Packages/jp.nobnak.gpu_uniform_grid/ShaderLibrary/LinkedList/UniformGridLinkedList.hlsl)).

| Area | Main types / assets |
|------|---------------------|
| 3D grid | [`UniformGridParams`](Packages/jp.nobnak.gpu_uniform_grid/Runtime/Data/UniformGridParams.cs), [`GPUUniformGrid`](Packages/jp.nobnak.gpu_uniform_grid/Runtime/LinkedList/GPUUniformGrid.cs), [`CPUUniformGrid`](Packages/jp.nobnak.gpu_uniform_grid/Runtime/LinkedList/CPUUniformGrid.cs), [`UniformGrid.compute`](Packages/jp.nobnak.gpu_uniform_grid/Resources/Shader/LinkedList/UniformGrid.compute) |
| 2D grid | [`UniformGridParams2D`](Packages/jp.nobnak.gpu_uniform_grid/Runtime/Data/UniformGridParams2D.cs), [`GPUUniformGrid2D`](Packages/jp.nobnak.gpu_uniform_grid/Runtime/LinkedList/GPUUniformGrid2D.cs), [`CPUUniformGrid2D`](Packages/jp.nobnak.gpu_uniform_grid/Runtime/LinkedList/CPUUniformGrid2D.cs), [`UniformGrid2D.compute`](Packages/jp.nobnak.gpu_uniform_grid/Resources/Shader/LinkedList/UniformGrid2D.compute) |
...
| HLSL helpers | [`UniformGrid-hl.hlsl`](Packages/jp.nobnak.gpu_uniform_grid/ShaderLibrary/LinkedList/UniformGrid-hl.hlsl), [`UniformGrid2D-hl.hlsl`](Packages/jp.nobnak.gpu_uniform_grid/ShaderLibrary/LinkedList/UniformGrid2D-hl.hlsl) — e.g. `InsertElementIdAtPosition`, `GetParticleDensityAtPosition` (define **`GET_PARTICLE_POSITION`**) |
| CPU readback | [`UniformGridConverter.ToCPU`](Packages/jp.nobnak.gpu_uniform_grid/Runtime/LinkedList/Converter/UniformGridConverter.cs) → `CPUUniformGrid` / `CPUUniformGrid2D` |
| Debug draw | [`UniformGridView`](Packages/jp.nobnak.gpu_uniform_grid/Runtime/LinkedList/View/UniformGridView.cs), [`UniformGridView2D`](Packages/jp.nobnak.gpu_uniform_grid/Runtime/LinkedList/View/UniformGridView2D.cs) + package shaders |
